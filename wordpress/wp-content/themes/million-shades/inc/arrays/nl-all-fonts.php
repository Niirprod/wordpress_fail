...
function million_shades_google_fonts_array() {
...
// this is "Web Safe FONTS" from WPBakery(vc core) and from w3c: http://www.w3schools.com/cssref/css_websafe_fonts.asp
			
function million_shades_web_safe_fonts() {
	$web_safe_font =  array(
	
			'Arial' => 'Arial, Helvetica, sans-serif',
			'Arial Black' => 'Arial Black, Gadget, sans-serif',
			'Book Antiqua' => 'Book Antiqua, Palatino, serif',
			'Bookman Old Style' =>'Bookman Old Style,tahoma, sans-serif',
